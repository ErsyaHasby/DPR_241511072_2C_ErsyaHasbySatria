...
class AnggotaController extends Controller {
    ...
    public function edit($id) {
        ...
        if (!$data['anggota']) return redirect()->to('/anggota')->with('error', 'Anggota tidak ditemukan');
        $data['title'] = 'Ubah Anggota DPR';
    ...
    public function update($id) {
        ...
        return redirect()->to('/anggota')->with('success', 'Anggota diubah');
    }

    public function delete($id) {
        $this->model->delete($id);
        return redirect()->to('/anggota')->with('success', 'Anggota dihapus');
    }
}